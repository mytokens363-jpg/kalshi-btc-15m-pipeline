...
from kalshi_bot.io.candles import NY_TZ, build_15m_candles, iter_ticks, write_candles_jsonl


def main() -> int:
    ap = argparse.ArgumentParser(description="Build 15-minute candles (America/New_York buckets) from external price JSONL")
    ...
    candles = build_15m_candles(ticks, tz=NY_TZ, symbol=args.symbol)
